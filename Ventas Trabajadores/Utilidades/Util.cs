...
namespace Griaule
{
    public class Util
    {
        private frmCaptaHuella myFormSegment;
        ...
        {
            myFormSegment.lvwFPReaders.Items.Add(msg);
            myFormSegment.lvwFPReaders.SelectedIndex = myFormSegment.lvwFPReaders.Items.Count - 1;
            myFormSegment.lvwFPReaders.ClearSelected();
	    ...
	    public void PrintBiometricDisplay(bool isBiometric, GrAfisConstants context, int finger) 
	    {
		    ...
		    if (isBiometric) 
            {
                ...
                else
                {
                    if (finger == 0)
                    {
                        Display(_raws1, context, myFormSegment.pictureBox1);
	    ...
	    public int ExtractTemplate() 
	    {
            ...
            myFormSegment = new frmCaptaHuella();
